...
<body>
    ...
    <div class="d-flex layout">
        <aside class="sidebar d-flex flex-column">
            ...
            <a href="<?php echo e(route('pengunjung.index')); ?>" class="nav-item">Halaman Pengunjung</a>
        ...
        <main class="main-content">
            <?php if(session('sukses')): ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert"><?php echo e(session('sukses')); ?><button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>
            <?php endif; ?>
            <?php if(session('gagal')): ?>
                <div class="alert alert-danger alert-dismissible fade show" role="alert"><?php echo e(session('gagal')); ?><button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>
            <?php endif; ?>
...
<?php /**PATH C:\laragon\www\aplikasi-blog-uas\resources\views/layouts/app.blade.php ENDPATH**/ ?>